...
/*     parentNodeWidth=d3.selectAll("#map-chart").node().parentElement.getBoundingClientRect().width;
    parentNodeHeight=d3.selectAll("#map-chart").node().parentElement.getBoundingClientRect().height; */
    parentNodeWidth=d3.selectAll("#map-chart").node().parentElement.getBoundingClientRect().width;
    parentNodeHeight=d3.selectAll("#map-chart").node().parentElement.getBoundingClientRect().height;
