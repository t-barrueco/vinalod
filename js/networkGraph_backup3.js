...
/*   vis.rect=vis.svg.append("rect")
  ...
  .on("mousemove", function (actual, i) {
    ...
    .on("end", function(){
      ...
      //vis.dragX=d3.event.transform.x-vis.dragX
      //vis.dragY=d3.event.transform.y-vis.dragY
      //////////////console.log("----CUANDO SE ACABA EL ZOOM-----")
      ...
      //////////////console.log("d3.event.transform.y: "+d3.event.transform.y)
      ////////////////console.log("vis.dragX: "+vis.dragX)
      ////////////////console.log("vis.dragY: "+vis.dragY)
      //vis.dragX=d3.event.transform.x
      //vis.dragY=d3.event.transform.y
      //////////////////console.log("end")
      //vis.dragX=d3.event.transform.x
...
NetworkGraph.prototype.initializeForces = function() {
  ...
  .on("end",function(){
    ...
    if((vis.dblClickId)&&(vis.addingGraph)){
      ...
      //////console.log(window.innerWidth/2)
      //////console.log(window.innerHeight/2)
      //////console.log(d3.select("#"+vis.dblClickId).data()[0]["x"]/vis.zoomScale)
      //////console.log(d3.select("#"+vis.dblClickId).data()[0]["y"]/vis.zoomScale)
      ////console.log(d3.select("#"+vis.dblClickId).data()[0]["x"])
      ////console.log(d3.select("#"+vis.dblClickId).data()[0]["y"])
      ////////////console.log(vis.dragX)
      ////////////console.log(vis.dragY)
      //var dcx = ((window.innerWidth/2-d3.select("#"+vis.dblClickId).data()[0]["x"])/vis.zoomScale);
      //var dcy = ((window.innerHeight/2-d3.select("#"+vis.dblClickId).data()[0]["y"])/vis.zoomScale);
...
/*       //console.log(translate[0])
      ...
      //vis.dragX=dcx
      //vis.dragY=dcy
      vis.centerGraphX=dcx2
      vis.centerGraphY=dcy2
      vis.dragX=0
      vis.dragY=0
      //////console.log(dcx)
      //////console.log(dcy)
