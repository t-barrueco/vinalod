...
async function startExpert(element){
  //console.log("antes de checkmenuItems")
  await checkMenuItems('form',element)
  //console.log("despues de checkMenuItems")
