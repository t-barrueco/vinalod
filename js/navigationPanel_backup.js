...
function labelsClickFreeGraph(element,newForm,form,propertyEl){
  //labelsClickFreeGraph(data["flatData"]["nodes"][0],subjectObject)
/*     formNav={"url","uri","subject-object"}
    ...
    //var imageS="/images/letter_s.svg",imageO="/images/letter_o.svg",imageP="/images/letter_p.svg"
