...
function applyFreeGraphFilter(element){
  ...
  //////////////////console.log("///applyFreeGraphFilter")
...
/*   if(element.value!="All"){
    branch[0].children.forEach(function (d){
      ...
      if(element.getAttribute("nodeType")=="property"){
        //////////////////////////console.log(d.value.toLowerCase())
        //////////////////////////console.log(element.value.toLowerCase())
        if(element.value.toLowerCase()!=d.property.toLowerCase()){
          d.hidden=true
        }else{
          d.hidden=false
        ...
        if(element.value.toLowerCase()!=d.type){
          d.hidden=true
        }else{
          d.hidden=false
          visibleNodesIds.push(d.id)
  ...
  for (i = 0; i < networkGraph.allData.links.length; i++) {
    //////////////////////////console.log(networkGraph.allData.links[i]["source"]["id"])
    //////////////////////////console.log(networkGraph.allData.links[i]["target"]["id"])
    //////////////////////////console.log(visibleNodesIds)
    //////////////////////////console.log((visibleNodesIds.includes(networkGraph.allData.links[i]["source"]["id"])))
    //////////////////////////console.log((visibleNodesIds.includes(networkGraph.allData.links[i]["target"]["id"])))
  ...
  //////////////////////////console.log(element.getAttribute("bubbleId"))
...
/*         if(filter.getAttribute("nodeType")=="property"){
          if(filter.value.toLowerCase()!=d.property.toLowerCase()){
            d.hidden=true
          }else{
            d.hidden=false
            visibleNodesIds.push(d.id)
          ...
          if(filter.value.toLowerCase()!=d.type){
            d.hidden=true
          }else{
            d.hidden=false
            visibleNodesIds.push(d.id)
  ...
  function checkNodeFilter2(filter,node){
    ...
    ////////console.log(filter)
    ////////////console.log(node)
    ////////console.log(filter.backValues)
    ////////console.log(node)
    if(filter.nodeType=="property"){
      console.log(filter.backValues)
      ////console.log(node.property.toLowerCase())
      if(filter.backValues!=undefined){
        if(!filter.backValues.includes(node.property.toLowerCase())){
          resultHidden=true
          //visibleNodesIds.push(node.id)
        //}else{
        //  node.hidden=true
        ...
        if(!filter.values.includes(node.property.toLowerCase())){
          resultHidden=true
          //visibleNodesIds.push(node.id)
        //}else{
        //  node.hidden=true
      ...
      if(filter.backValues!=undefined){
        if(!filter.backValues.includes(node.type.toLowerCase())){
          resultHidden=true
          //visibleNodesIds.push(node.id)
        //}else{
        //  node.hidden=true 
        ...
        if(!filter.values.includes(node.type.toLowerCase())){
          resultHidden=true
          //visibleNodesIds.push(node.id)
        //}else{
        //  node.hidden=true 
...
/*       if(!node.hidden){
      ...
      node.children.forEach(function (d){
        ...
        if(node.hidden==true){
          //////console.log("el padre  es hidden")
          d.hidden=true
        }else{
          if(filtersBranch.length>0){
            //////console.log("mira los filters")
            ////////////console.log(filtersBranch)
            for (i = 0; i < filtersBranch.length; i++) {
            //filtersBranch.forEach(function (f){
              ////////console.log(f)
              //////console.log(document.getElementById(filtersBranch[i].name).value)
              ////////console.log(d)
              ////console.log(filtersBranch[i])
...
function applyFreeGraphFilter_backup(element){
  var bubble,nodes=[],links=[],empty=true,element_range,filters=[],valuesFilter=[],values=[],classFilter,allValues,parent;
...
function restartFreeGraph(element){
  ...
  for (let i = 0; i < classElement.children.length; i++) {
    console.log(classElement.children[i].querySelector("select").getAttribute("classFilterName"))
    document.getElementById(classElement.children[i].id.replace("_root","")).value="All"
  }
  ////////////////////////////////////console.log(filtersList)
  filtersList.forEach(function(f){
    //console.log(classElement.getAttribute("id").replace("_filters",""))
...
function checkFilterIcon(element){
  ...
  //////////////////console.log(classElement)
  for (let i = 0; i < classElement.children.length; i++) {
    //////////////////console.log(classElement.children[i].id)
