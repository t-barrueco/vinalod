...
MenuItems.prototype.init = async function () {
  ...
  //console.log("antes buildOptions")
  await mi.buildOptions()
  //console.log(mi)
  //console.log("estoy aqui")
  mi.filterByMenuOption()
  //console.log("antes de filter by askresult")
  await mi.filterByAskResult()
  //console.log("despues de filterbyaskresult")
}
...
MenuItemsExpert.prototype.filterByAskResult = async function () {
  ...
  for (let i = 0; i < mi.indexRows.length; i++) {
    if(!(mi.indexRows[i] instanceof OptionNodeBasic)){
      //console.log(mi.indexRows[i].endpoint_url)
...
MenuItemsBasic.prototype.buildOptions=function (){
  let mi=this;
  console.log(configFile.getRowsNodeClass(mi.node["className"]))
