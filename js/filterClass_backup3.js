...
FilterClassBasic.prototype.addFilter = function () {
  var cf=this
  console.log(cf)
}
/* FilterClassBasic.prototype.addFilterValues = function () {
  var cf=this
  console.log(cf)
} */
...
/* function FilterBasicDropdown(...args){
  FilterBasic.apply(this, args);
  } */

//FilterBasicDropdown.prototype = Object.create(FilterBasic.prototype);

FilterBasicDropdown.prototype.test=function(){
  //console.log(test)
}
