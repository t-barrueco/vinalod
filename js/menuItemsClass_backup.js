...
/* MenuItems.prototype.init = async function () {
        ...
        const getSpreadsheetData = () => {
            return new Promise(function(resolve, reject){
                d3.csv("../config_vinalod/sparqlEndpoints.csv",async function(urls){
                    ////////////////////////////////////////////console.log(urls)
                    let so=mi.node["subject-object"]
                    let node = mi.node["subject-object"]
    ...
    function addIndexRows(result){
        console.log(result)
        
        //mi.selectedRows=mi.indexRows
        mi.selectedRows=result
        console.log(mi.selectedRows)
        mi.selectedRows.forEach(element => {
            mi.indexRows.push(new ConfigRow(element))
        });
        //console.log("after configRow")
      }
...
/*         await d3.csv("../config_vinalod/sparqlEndpoints.csv",async function(urls){
            ////////////////////////////////////////////console.log(urls)
            let so=mi.node["subject-object"]
            let node = mi.node["subject-object"]
